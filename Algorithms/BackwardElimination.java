...
public class BackwardElimination extends Search {

	public BackwardElimination(int f) {
		super(f);
		// TODO Auto-generated constructor stub
		initial = new State(this.featureNum);
	}
	...
	public PriorityQueue<State> expand(PriorityQueue<State> pq, State s) {
		...
		for(int i = 1; i <= featureNum; i++) {
			...
			State copy = new State(s.features, s.accuracy);
			State child = ops.removeFeature(copy, i);
			pq.add(child);
			updateMax(child);
